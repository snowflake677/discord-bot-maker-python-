...
bw = tk.Label(config_win, text='audio config:', relief=GROOVE)
bw.place(relx=0.75, rely=0.16, anchor=CENTER)




bw = tk.Label(config_win, text='chatGPT config:', relief=GROOVE)
bw.place(relx=0.75, rely=0.34, anchor=CENTER)

bw = tk.Label(config_win, text='module5 config:', relief=GROOVE)
